...
Когда вы запустите проект вас перебросит в главное меню, где в верхней панеле будет кнопка Alcoland (она перенаправляет на главную страницу '/') , далее кнопка поддержки ( ее логику я пока не разработал ), далее идет корзина, она рабочая, вы можете подабавлять товары , поуправлять их количеством и отправить в базу данных на сохранение. 
